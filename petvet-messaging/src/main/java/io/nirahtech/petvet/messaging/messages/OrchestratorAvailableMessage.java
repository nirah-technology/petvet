...
public final class OrchestratorAvailableMessage extends AbstractMessage {
    private OrchestratorAvailableMessage(
        ...
        super(emitterId, emitterMAC, emitterIP, emitterMode, MessageType.ORCHESTRATOR_AVAILABLE, sentAt);
    }

    public static OrchestratorAvailableMessage create(final UUID emitterId, final MacAddress emitterMAC, final InetAddress emitterIP, final EmitterMode emitterMode) {
        return new OrchestratorAvailableMessage(emitterId, emitterMAC, emitterIP, emitterMode, LocalDateTime.now());
    }
        ...
        if (messageAsString.contains(":")) {
            ...
            if (type.equals(MessageType.ORCHESTRATOR_AVAILABLE)) {
                ...
                try {
                    ...
                    final OrchestratorAvailableMessage message = new OrchestratorAvailableMessage(id, mac, ip, mode, sendedAt);
