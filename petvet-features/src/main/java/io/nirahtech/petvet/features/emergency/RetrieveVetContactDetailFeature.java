 ...
 */
@FunctionalInterface
public interface RetrieveVetContactDetailFeature {
    Optional<Vet> retrieveEmergencyContactDetail(final VetIdentifier vetIdentifier) throws FeatureExecutionException;
}
