 ...
 */
@FunctionalInterface
public interface RegisterNewEmergencyContactFeature {
    void registerNewEmergencyContact(final Company emergencyCompanyContact) throws FeatureExecutionException;
}
